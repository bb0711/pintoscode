...
static bool big_priority(const struct list_elem *a, const struct list_elem *b, void *aux UNUSED){
...
thread_unblock (struct thread *t)
{
  ...
  list_insert_ordered(&ready_list, &t->elem, big_priority, NULL);
...
thread_yield (void)
{
  ...
  old_level = intr_disable ();
  if (curr != idle_thread)
    list_insert_ordered(&ready_list, &curr->elem, big_priority, NULL);
...
next_thread_to_run (void)
{
  if (list_empty (&ready_list))
    ...
    list_sort(&ready_list, big_priority, NULL);
